...
export const metadata: Metadata = {
  title: "War Training Center - Tactical Combat Training for Housewives",
  description: "Transform from homemaker to tactical operative with our specialized killhouse training programs. Master combat skills, weapons training, and warfare techniques designed for housewives.",
  keywords: ["tactical training", "combat training", "housewives training", "killhouse", "weapons training", "self defense", "military training", "tactical skills"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "War Training Center - Elite Tactical Training for Housewives",
    description: "Master combat skills and tactical warfare in our specialized killhouse facility. Professional training programs designed for housewives.",
    siteName: "WAR TACTICAL",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763394434107-e0bmyyx7.jpg",
      alt: "Tactical training session"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "War Training Center - Tactical Combat Training for Housewives",
    description: "Transform from homemaker to tactical operative with our specialized training programs.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763394434107-e0bmyyx7.jpg"]
  }
};
